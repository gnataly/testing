...
public interface IAccountRepository
{
    ...
    Task<bool> IsFavoriteActorAsync(int accountId, int actorId);
    Task<bool> IsFavoriteMusicalAsync(int accountId, int musicalId);
    Task<bool> IsFavoriteTheatreAsync(int accountId, int theatreId);
}